...
export function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      payment: "Paiement en 2 ou 3x possible",
      description:
    ...
    },
    {
      ...
      description:
        "Application web sur mesure selon vos besoins spécifiques et votre secteur.",
      features: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mb-4">
                <div
                  className={`text-2xl font-bold ${service.highlight ? "text-purple-600" : "text-purple-600 dark:text-purple-400"}`}
                >
                  {service.price}
                </div>
