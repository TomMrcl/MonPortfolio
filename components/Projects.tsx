...
export function Projects() {
  ...
  return (
    <section id="projects" className="py-20 scroll-mt-16 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Découvrez quelques réalisations qui illustrent mon savoir-faire et
            ma passion pour le développement web moderne.
          </p>
        </div>
